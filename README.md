eband_interactive_local_planner
===================

The eband_interactive_local_planner is
...
It implements the Elastic Band method on the SE2 manifold with some interactive modifications.
